...
def replace_circuits(filepath):
    ...
    # The markers found earlier
    find_and_replace_div('Example: Bell State Circuit', bell_circuit)
    find_and_replace_div('{/*  Bell State Circuit  */}', bell_circuit) # the second one
    find_and_replace_div('{/*  Teleportation Circuit  */}', tele_circuit)
    find_and_replace_div('{/*  Superdense Coding Circuit  */}', sdc_circuit)
