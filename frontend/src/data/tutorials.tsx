        ...
        subModules: [
          ...
          ═══════════════════════════════════════════════════ */
          {
            ...
            lessonContent: (
              <>
                <p style={{ marginBottom: '16px' }}>
                  <strong>Entanglement</strong> is the quantum phenomenon where two qubits become so correlated that measuring one <em>instantly</em> determines the state of the other — no matter how far apart they are.
            ...
            practiceGoal: 'Trace through the Bell State circuit and write out the state at each timestep.',
          },
          ...
          ═══════════════════════════════════════════════════ */
          {
            ...
            description: 'Transfer a qubit state from Alice to Bob using entanglement and classical communication — no physical qubit moves!',
            difficulty: 'Intermediate',
            lessonContent: (
              <>
                <p style={{ marginBottom: '16px' }}>
                ...
                {/* Correction table */}
                <h3 style={{ fontSize: '18px', color: 'var(--text-primary)', marginTop: '28px', marginBottom: '12px' }}>Bob's Correction Table</h3>
                <div style={{ overflowX: 'auto' }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
                    <thead>
                      <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.15)' }}>
          ...
          ═══════════════════════════════════════════════════ */
          {
            ...
            description: 'Send 2 classical bits of information by transmitting just 1 qubit, using a shared Bell pair.',
            difficulty: 'Intermediate',
            lessonContent: (
              <>
                <p style={{ marginBottom: '16px' }}>
                ...
                <div style={{ background: 'rgba(210,153,34,0.03)', border: '1px solid rgba(210,153,34,0.2)', borderRadius: '10px', padding: '16px 20px', marginBottom: '24px' }}>
                  <h4 style={{ color: '#d29922', margin: '0 0 8px 0', fontSize: '15px' }}>⚠ Convention Note</h4>
                  <p style={{ color: 'var(--text-secondary)', margin: 0, fontSize: '14px', lineHeight: '1.7' }}>
                    We represent Alice's qubit as <code>q_A</code> (top line) and Bob's qubit as <code>q_B</code> (bottom line). <br />
                    The combined state is written as <code>|q_A q_B⟩</code> read from left to right.
                  </p>
                </div>

                {/* Encoding table */}
                <h3 style={{ fontSize: '20px', color: 'var(--text-primary)', marginTop: '8px', marginBottom: '12px' }}>Alice's Encoding (4 possible messages)</h3>
                <div style={{ overflowX: 'auto', marginBottom: '28px' }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
                    <thead>
                      <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.15)' }}>
                        <th style={{ textAlign: 'center', padding: '10px 14px', color: 'var(--text-primary)' }}>Message (bits)</th>
                        <th style={{ textAlign: 'center', padding: '10px 14px', color: 'var(--text-primary)' }}>Gate Alice applies</th>
                        <th style={{ textAlign: 'center', padding: '10px 14px', color: 'var(--text-primary)' }}>Resulting Bell State</th>
                        <th style={{ textAlign: 'center', padding: '10px 14px', color: 'var(--text-primary)' }}>State formula</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ['00', 'I (identity)', '|Φ⁺⟩', '1/\u221a2(|00⟩ + |11⟩)'],
                        ['01', 'X (bit flip)', '|Ψ⁺⟩', '1/\u221a2(|10⟩ + |01⟩)'],
                        ['10', 'Z (phase flip)', '|Φ⁻⟩', '1/\u221a2(|00⟩ − |11⟩)'],
                        ['11', 'XZ (both)', '|Ψ⁻⟩', '1/\u221a2(|10⟩ − |01⟩)'],
                      ].map(([msg, gate, bell, state], i) => (
                        <tr key={i} style={{ borderBottom: '1px solid rgba(255,255,255,0.06)', background: i % 2 === 0 ? 'rgba(255,255,255,0.02)' : 'transparent' }}>
                          <td style={{ padding: '10px 14px', textAlign: 'center', fontFamily: 'monospace', fontWeight: 'bold', color: 'var(--accent-primary)', fontSize: '16px' }}>{msg}</td>
                          <td style={{ padding: '10px 14px', textAlign: 'center', fontFamily: 'monospace', color: '#3fb950', fontWeight: 'bold' }}>{gate}</td>
                          <td style={{ padding: '10px 14px', textAlign: 'center', color: '#d29922', fontWeight: 'bold' }}>{bell}</td>
                ...
                <h3 style={{ fontSize: '20px', color: 'var(--text-primary)', marginTop: '8px', marginBottom: '8px' }}>Superdense Coding Circuit</h3>
                <p style={{ marginBottom: '16px', fontSize: '14px', color: 'var(--text-secondary)' }}>
                  Alice encodes the classical bits <strong>a</strong> and <strong>b</strong> by applying gates, then transmits her qubit to Bob. Bob decodes the state using a CNOT and a Hadamard gate.
                </p>
                <div style={{ background: 'rgba(0,0,0,0.3)', borderRadius: '12px', padding: '28px 24px', margin: '16px 0', overflowX: 'auto', border: '1px solid rgba(255,255,255,0.05)' }}>
                  <div style={{
                    display: 'grid',
                    gridTemplateColumns: '60px 80px 60px 60px 80px 60px 60px 60px',
                    gridTemplateRows: '30px 30px 60px 60px 60px',
                    minWidth: '520px',
                    alignItems: 'center',
                    position: 'relative'
                  }}>

                    {/* Classical Wires at the top */}
                    {/* Row 1: Classical bit a */}
                    <span style={{ color: 'var(--text-secondary)', fontSize: '13px', fontFamily: 'monospace', justifySelf: 'center', gridRow: '1', gridColumn: '1' }}>a</span>
                    <div style={{ gridRow: '1', gridColumn: '2 / 5', display: 'flex', alignItems: 'center', height: '100%' }}>
                      <div style={{ height: '4px', borderTop: '1px solid rgba(255,255,255,0.4)', borderBottom: '1px solid rgba(255,255,255,0.4)', width: '100%' }} />
                    </div>

                    {/* Row 2: Classical bit b */}
                    <span style={{ color: 'var(--text-secondary)', fontSize: '13px', fontFamily: 'monospace', justifySelf: 'center', gridRow: '2', gridColumn: '1' }}>b</span>
                    <div style={{ gridRow: '2', gridColumn: '2 / 5', display: 'flex', alignItems: 'center', height: '100%' }}>
                      <div style={{ height: '4px', borderTop: '1px solid rgba(255,255,255,0.4)', borderBottom: '1px solid rgba(255,255,255,0.4)', width: '100%' }} />
                    </div>

                    {/* Curly Bracket (spans Row 3 to 5, Column 2) */}
                    <div style={{ gridRow: '3 / 6', gridColumn: '2', height: '100%', position: 'relative', pointerEvents: 'none' }}>
                      <div style={{
                        position: 'absolute',
                        left: '10px',
                        top: '30px',
                    ...
                    {/* ROW 3: Alice's qubit q_A before transmission */}
                    {/* Wire start in Column 2 */}
                    <div style={{ gridRow: '3', gridColumn: '2', width: '100%', height: '100%', display: 'flex', alignItems: 'center', position: 'relative' }}>
                      <div style={{ position: 'absolute', left: '20px', right: 0, height: '2px', background: 'rgba(255,255,255,0.3)' }} />
                    </div>

                    {/* Z Gate (Column 3) */}
                    <div style={{ gridRow: '3', gridColumn: '3', position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {/* Horizontal quantum wire */}
                      <div style={{ position: 'absolute', left: 0, right: 0, height: '2px', background: 'rgba(255,255,255,0.3)', zIndex: 0 }} />
                      {/* Vertical classical control line from a (Row 1) */}
                      <div style={{ position: 'absolute', top: '-75px', bottom: '50%', width: '4px', borderLeft: '1px solid rgba(255,255,255,0.4)', borderRight: '1px solid rgba(255,255,255,0.4)', zIndex: 0 }} />
                      {/* Gate Box */}
                      <div style={{ zIndex: 1, width: '36px', height: '36px', border: '2px solid var(--text-secondary)', borderRadius: '4px', background: 'rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '14px', color: 'var(--text-secondary)' }}>Z</div>
                    </div>

                    {/* X Gate (Column 4) */}
                    <div style={{ gridRow: '3', gridColumn: '4', position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {/* Horizontal quantum wire */}
                      <div style={{ position: 'absolute', left: 0, right: 0, height: '2px', background: 'rgba(255,255,255,0.3)', zIndex: 0 }} />
                      {/* Vertical classical control line from b (Row 2) */}
                      <div style={{ position: 'absolute', top: '-45px', bottom: '50%', width: '4px', borderLeft: '1px solid rgba(255,255,255,0.4)', borderRight: '1px solid rgba(255,255,255,0.4)', zIndex: 0 }} />
                      {/* Gate Box */}
                      <div style={{ zIndex: 1, width: '36px', height: '36px', border: '2px solid var(--text-secondary)', borderRadius: '4px', background: 'rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '14px', color: 'var(--text-secondary)' }}>X</div>
                    </div>

                    {/* Transmission (Spans Row 3 to 4, Column 5) */}
                    <div style={{ gridRow: '3 / 5', gridColumn: '5', position: 'relative', width: '100%', height: '100%', justifySelf: 'stretch' }}>
                      <svg style={{ width: '100%', height: '100%', overflow: 'visible' }}>
                        <path
                          d="M 0 30 L 15 30 L 65 90 L 80 90"
                          fill="none"
                          stroke="rgba(255,255,255,0.3)"
                          strokeWidth="2"
                        />
                      </svg>
                      {/* Label on the sloped line */}
                      <span style={{ position: 'absolute', left: '20px', top: '35px', fontSize: '11px', color: 'var(--accent-primary)', transform: 'rotate(37deg)', transformOrigin: 'left top', background: 'rgba(0,0,0,0.6)', padding: '2px 4px', borderRadius: '4px' }}>Send Qubit</span>
                    </div>

                    {/* ROW 4: Bob's top input line (after transmission) */}
                    {/* CNOT Control (Column 6) */}
                    <div style={{ gridRow: '4', gridColumn: '6', position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {/* Horizontal quantum wire */}
                      <div style={{ position: 'absolute', left: 0, right: 0, height: '2px', background: 'rgba(255,255,255,0.3)' }} />
                      {/* Control dot */}
                      <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: 'var(--text-secondary)', zIndex: 1 }} />
                      {/* Vertical line down to target */}
                      <div style={{ position: 'absolute', top: '50%', height: '60px', width: '2px', background: 'var(--text-secondary)' }} />
                    </div>

                    {/* H Gate (Column 7) */}
                    <div style={{ gridRow: '4', gridColumn: '7', position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {/* Horizontal quantum wire */}
                      <div style={{ position: 'absolute', left: 0, right: 0, height: '2px', background: 'rgba(255,255,255,0.3)' }} />
                      {/* Gate Box */}
                      <div style={{ zIndex: 1, width: '36px', height: '36px', border: '2px solid var(--text-secondary)', borderRadius: '4px', background: 'rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '14px', color: 'var(--text-secondary)' }}>H</div>
                    </div>

                    {/* Output |a> (Column 8) */}
                    <div style={{ gridRow: '4', gridColumn: '8', display: 'flex', alignItems: 'center', height: '100%' }}>
                      <div style={{ width: '15px', height: '2px', background: 'rgba(255,255,255,0.3)' }} />
                      <span style={{ fontFamily: 'monospace', fontSize: '13px', marginLeft: '6px', color: 'var(--accent-primary)' }}>|a⟩</span>
                    </div>

                    {/* ROW 5: Bob's bottom qubit q_B */}
                    {/* Wire start in Column 2 */}
                    <div style={{ gridRow: '5', gridColumn: '2', width: '100%', height: '100%', display: 'flex', alignItems: 'center', position: 'relative' }}>
                      <div style={{ position: 'absolute', left: '20px', right: 0, height: '2px', background: 'rgba(255,255,255,0.3)' }} />
                    </div>

                    {/* Spacer wires for Columns 3, 4, 5 */}
                    <div style={{ gridRow: '5', gridColumn: '3', display: 'flex', alignItems: 'center', height: '100%' }}><div style={{ height: '2px', background: 'rgba(255,255,255,0.3)', width: '100%' }} /></div>
                    <div style={{ gridRow: '5', gridColumn: '4', display: 'flex', alignItems: 'center', height: '100%' }}><div style={{ height: '2px', background: 'rgba(255,255,255,0.3)', width: '100%' }} /></div>
                    <div style={{ gridRow: '5', gridColumn: '5', display: 'flex', alignItems: 'center', height: '100%' }}><div style={{ height: '2px', background: 'rgba(255,255,255,0.3)', width: '100%' }} /></div>

                    {/* CNOT Target (Column 6) */}
                    <div style={{ gridRow: '5', gridColumn: '6', position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {/* Horizontal quantum wire */}
                      <div style={{ position: 'absolute', left: 0, right: 0, height: '2px', background: 'rgba(255,255,255,0.3)' }} />
                      {/* Target circle */}
                      <div style={{ zIndex: 1, width: '22px', height: '22px', border: '2px solid var(--text-secondary)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '15px', color: 'var(--text-secondary)', background: '#0d1117' }}>⊕</div>
                    </div>

                    {/* Spacer wire for Column 7 */}
                    <div style={{ gridRow: '5', gridColumn: '7', display: 'flex', alignItems: 'center', height: '100%' }}><div style={{ height: '2px', background: 'rgba(255,255,255,0.3)', width: '100%' }} /></div>

                    {/* Output |b> (Column 8) */}
                    <div style={{ gridRow: '5', gridColumn: '8', display: 'flex', alignItems: 'center', height: '100%' }}>
                      <div style={{ width: '15px', height: '2px', background: 'rgba(255,255,255,0.3)' }} />
                      <span style={{ fontFamily: 'monospace', fontSize: '13px', marginLeft: '6px', color: 'var(--accent-primary)' }}>|b⟩</span>
                    </div>
                ...
                {/* ── Step by Step ── */}
                <h3 style={{ fontSize: '20px', color: 'var(--text-primary)', marginTop: '32px', marginBottom: '16px' }}>Step-by-Step State Analysis (sending "11")</h3>
                <p style={{ marginBottom: '16px', color: 'var(--text-secondary)', fontSize: '14px' }}>
                  We track the 2-qubit state <strong>|q_A q_B⟩</strong> (where q_A is Alice's top qubit and q_B is Bob's bottom qubit) at each timestep T.
                </p>
                {[
                  {
                    t: 'T=0', label: 'Initial State', color: 'var(--text-secondary)',
                  ...
                  {
                    t: 'T=5', label: 'Bob applies H on q_A', color: '#b28215',
                ...
                {/* Comparison table */}
                <h3 style={{ fontSize: '18px', color: 'var(--text-primary)', marginTop: '28px', marginBottom: '12px' }}>Teleportation vs Superdense Coding</h3>
                <div style={{ overflowX: 'auto' }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
                    <thead>
                      <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.15)' }}>
                        <th style={{ textAlign: 'left', padding: '10px 14px', color: 'var(--text-primary)' }}>Property</th>
                        <th style={{ textAlign: 'center', padding: '10px 14px', color: 'var(--accent-primary)' }}>Teleportation</th>
                        <th style={{ textAlign: 'center', padding: '10px 14px', color: '#3fb950' }}>Superdense Coding</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ['What is sent?', '1 qubit (state)', '1 qubit (physical)'],
                        ['What is received?', '1 qubit state |ψ⟩', '2 classical bits'],
                        ['Classical bits used', '2 bits (corrections)', '0 bits over quantum channel'],
                        ['Pre-shared resource', 'Bell pair', 'Bell pair'],
                        ['Direction of info flow', 'Quantum → Classical', 'Classical → Quantum channel'],
                        ['Alice\'s qubit destroyed?', 'Yes (no cloning)', 'Yes (sent to Bob)'],
                      ].map(([prop, tel, sdc], i) => (
                        <tr key={i} style={{ borderBottom: '1px solid rgba(255,255,255,0.06)', background: i % 2 === 0 ? 'rgba(255,255,255,0.02)' : 'transparent' }}>
                          <td style={{ padding: '10px 14px', color: 'var(--text-secondary)' }}>{prop}</td>
                          <td style={{ padding: '10px 14px', textAlign: 'center', color: 'var(--accent-primary)', fontFamily: 'monospace', fontSize: '13px' }}>{tel}</td>
                          <td style={{ padding: '10px 14px', textAlign: 'center', color: '#3fb950', fontFamily: 'monospace', fontSize: '13px' }}>{sdc}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
          ...
          },
          {
            ...
            lessonContent: (
              <>
                <p style={{ marginBottom: '16px' }}>
                  Ready to test your understanding of quantum circuits? This quiz features <strong>15 challenging circuit questions</strong> where you are given a circuit and must calculate the measurement probabilities of the outcomes. Pass this quiz to complete the Quantum Circuits module!
                </p>
              </>
            ),
            ...
            quizzes: [
              {
                question: 'A 2-qubit circuit initialized to |00⟩ applies a Hadamard gate to qubit 0 (control), then a CNOT gate (control=0, target=1). What is the probability of measuring the system in the state |11⟩?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 2,
                explanation: 'Applying H to qubit 0 creates 1/\u221a2(|00⟩ + |10⟩). The CNOT (control=0, target=1) maps |10⟩ to |11⟩. The resulting state is the Bell state 1/\u221a2(|00⟩ + |11⟩). The probability of measuring |11⟩ is |1/\u221a2|^2 = 50%.'
              },
              {
                question: 'A 2-qubit circuit is prepared in the state |+-⟩. If we apply a CNOT gate where the first qubit (control) is the control and the second qubit (target) is the target, what is the probability of measuring the system in the state |--⟩?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                explanation: 'By the phase kickback effect, when a CNOT is applied to a control in the |+⟩ state and target in the |-⟩ state, the target remains unchanged as |-⟩, and the control undergoes a phase flip, turning into |-⟩. The final state is |--⟩, yielding 100% probability of measuring |--⟩.'
              },
              {
                question: 'A single qubit is initialized to |0⟩. We apply a Hadamard gate, followed by a Pauli-Z gate, followed by another Hadamard gate. What is the probability of measuring the state |1⟩?',
                options: [
                  '0%',
                  '50%',
                  '100%',
                ...
                correctAnswerIndex: 2,
                explanation: 'H maps |0⟩ to |+⟩. Z maps |+⟩ to |-⟩. The final H maps |-⟩ to |1⟩. Thus, measuring the state yields |1⟩ with 100% probability (this circuit performs H Z H = X, flipping the qubit).'
              },
              {
                question: 'A 2-qubit circuit is initialized to |00⟩. We apply Hadamard gates to both qubits, and then apply a CNOT gate (control=0, target=1). What is the probability of measuring the state |01⟩?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 1,
                explanation: 'Applying H to both qubits yields |++⟩ = 1/2(|00⟩ + |01⟩ + |10⟩ + |11⟩). CNOT (control=0, target=1) maps |10⟩ to |11⟩ and |11⟩ to |10⟩. The state remains 1/2(|00⟩ + |01⟩ + |11⟩ + |10⟩) = |++⟩. Thus, each basis state has a 25% probability of being measured.'
              },
              {
                question: 'In a 2-qubit circuit initialized to |00⟩, we apply a Hadamard gate on qubit 0 (control) and a Pauli-X gate on qubit 1 (target). We then apply a CNOT gate. What is the probability of measuring the state |10⟩?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 2,
                explanation: 'After H on 0 and X on 1, the state is 1/\u221a2(|01⟩ + |11⟩). The CNOT maps |01⟩ to |01⟩ and |11⟩ to |10⟩. The final state is 1/\u221a2(|01⟩ + |10⟩). The probability of measuring |10⟩ is |1/\u221a2|^2 = 50%.'
              },
              {
                question: 'In the Quantum Teleportation circuit, if Alice measures her qubits and obtains the outcome m_Q = 1 and m_A = 0, what is the probability that Bob measures his qubit B as |1⟩ BEFORE he applies any correction gates, assuming the state to teleport was |ψ⟩ = 1/\u221a2(|0⟩ + |1⟩)?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 2,
                explanation: 'When Alice measures m_Q = 1, m_A = 0, Bob\'s qubit is projected into the state \u03b1|0⟩ − \u03b2|1⟩. Since the teleported state had \u03b1 = \u03b2 = 1/\u221a2, Bob\'s qubit is in state 1/\u221a2(|0⟩ − |1⟩). Measuring this gives 50% probability of |1⟩.'
              },
              {
                question: 'In Superdense Coding, Alice encodes the classical message "01" (applying X to q_A). If Bob\'s CNOT gate fails and acts as an Identity gate instead, what is the probability that Bob measures the state |01⟩?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 1,
                explanation: 'Alice encodes "01", transforming the Bell state to 1/\u221a2(|10⟩ + |01⟩). If Bob\'s CNOT does nothing, applying H on q_A results in 1/2(|00⟩ − |10⟩ + |01⟩ + |11⟩). The probability of measuring |01⟩ is (1/2)^2 = 25%.'
              },
              {
                question: 'In the Bell state creation circuit (H on q_0, CNOT with control q_0 and target q_1), suppose the CNOT gate has a systematic error where it only performs a controlled phase-flip (CZ) instead of a CNOT. If we measure both qubits, what is the probability of measuring the state |10⟩?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 2,
                explanation: 'H on q_0 creates 1/\u221a2(|00⟩ + |10⟩). The CZ gate flips the sign of the state if both qubits are |1⟩. Since qubit 1 is in state |0⟩, the CZ gate acts as Identity. The final state remains 1/\u221a2(|00⟩ + |10⟩), yielding 50% probability of measuring |10⟩.'
              },
              {
                question: 'In Superdense Coding, Alice encodes the message "10" (applying Z to q_A). If Bob\'s H gate fails and acts as an Identity instead, what is the probability that Bob measures the state |11⟩ after a successful CNOT?',
                options: [
                  '0%',
                  '50%',
                  '100%',
                ...
                correctAnswerIndex: 0,
                explanation: 'Alice applies Z to 1/\u221a2(|00⟩ + |11⟩) → 1/\u221a2(|00⟩ − |11⟩). Bob applies CNOT → 1/\u221a2(|00⟩ − |10⟩). Since the H gate fails, measuring yields |00⟩ and |10⟩ with 50% probability each. The probability of measuring |11⟩ is 0%.'
              },
              {
                question: 'During Quantum Teleportation of the state |1⟩, Alice measures m_Q = 1 and m_A = 1. If Bob fails to apply the correction gates (applies Identity instead), what is the probability that Bob measures his qubit as |0⟩?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 3,
                explanation: 'The state to teleport is |1⟩ (\u03b1=0, \u03b2=1). Alice\'s measurement of 11 projects Bob\'s qubit to \u03b1|1⟩ − \u03b2|0⟩ = -|0⟩. Without correction, measuring this state yields |0⟩ with 100% probability.'
              },
              {
                question: 'A 2-qubit circuit initialized to |00⟩ applies an H gate to qubit 0, followed by an S gate (which maps |1⟩ to i|1⟩) to qubit 0, and then a CNOT gate (control=0, target=1). If we measure the system, what is the probability of measuring |11⟩?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 2,
                explanation: 'H on 0 creates 1/\u221a2(|00⟩ + |10⟩). S on 0 maps it to 1/\u221a2(|00⟩ + i|10⟩). CNOT maps this to 1/\u221a2(|00⟩ + i|11⟩). The probability of measuring |11⟩ is |i/\u221a2|^2 = 50%.'
              },
              {
                question: 'In Superdense Coding, Alice applies the XZ gate to her qubit to encode the message "11". If the circuit runs perfectly, what is the probability that Bob measures the state |11⟩ at the end?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 3,
                explanation: 'Under perfect conditions, Superdense Coding has a 100% success rate. Encoding "11" maps the shared Bell state to |11⟩ after Bob\'s CNOT + H decoding, yielding 100% measurement probability.'
              },
              {
                question: 'A circuit creates the Bell state 1/\u221a2(|00⟩ + |11⟩). We measure the first qubit and get the outcome 1. What is the probability that a subsequent measurement of the second qubit will yield the outcome 0?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 0,
                explanation: 'The Bell state contains only |00⟩ and |11⟩ terms. Measuring the first qubit as 1 collapses the state to |11⟩. The second qubit is now guaranteed to collapse to 1, meaning the probability of measuring 0 is 0%.'
              },
              {
                question: 'In a 2-qubit circuit starting in the state |01⟩, we apply three CNOT gates in sequence: CNOT(0,1), CNOT(1,0), and CNOT(0,1). What is the probability of measuring the system in the state |10⟩?',
                options: [
                  '0%',
                  '25%',
                  '50%',
                ...
                correctAnswerIndex: 3,
                explanation: 'A sequence of three alternating CNOT gates acts as a SWAP gate, exchanging the states of the two qubits. The initial state |01⟩ is swapped to |10⟩, giving 100% probability of measuring |10⟩.'
              },
              {
                question: 'In a 2-qubit circuit initialized to |01⟩, we apply two identical CNOT gates (control=0, target=1) in immediate succession. What is the probability of measuring |01⟩?',
                options: [
                  '0%',
                  '50%',
                  '100%',
                ...
                correctAnswerIndex: 2,
                explanation: 'Since the CNOT gate is its own inverse (CNOT^2 = I), applying two identical CNOT gates in succession results in the identity operation. The state remains |01⟩, yielding 100% probability of measuring |01⟩.'
              }
            ]
          }
        ]
