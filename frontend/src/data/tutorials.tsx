              ...
              <>
                ...
                >
                  ...
                  */}
                  ...
                  >
                    ...
                    <span>
                      <span style={{ color: "#3fb950" }}>⊕</span> Target qubit /
                      CNOT flip (q₂)
                    </span>
                    <span style={{ color: "#d29922", fontWeight: "bold" }}>
                      M
                    </span>
                    <span> Measurement → classical bit</span>
                  </div>
                </div>
                ...
                >
                  {[
                    {
                      step: "1",
                      label: "Start from the left",
                      desc: "Qubits are initialized (usually to |0⟩). Each horizontal wire is one qubit.",
                    },
                    {
                      step: "2",
                      label: "Apply gates left → right",
                      desc: "Each gate box you encounter transforms the qubit. The order matters — gates do not commute in general.",
                    },
                    {
                      step: "3",
                      label: "Multi-qubit gates span rows",
                      desc: "A CNOT connects two wires with a vertical line — the dot (●) is the control, the circle-plus (⊕) is the target.",
                    },
                    {
                      step: "4",
                      label: "Measure at the end",
                      desc: "An M gate collapses the quantum state to a classical 0 or 1. Double wires carry classical bits after measurement.",
                    },
                  ].map(({ step, label, desc }) => (
                    <div
                      key={step}
                ...
                >
                  Circuit Notation vs. Matrix Math
                </h3>
                <p style={{ marginBottom: "16px" }}>
                  Every circuit diagram has an equivalent matrix representation.
                  Gates applied in sequence correspond to{" "}
                  <strong>matrix multiplication</strong> (right to left in math
                  notation).
                </p>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    Bell State circuit ↔ Matrix equation:
                  </div>
                  <div
                    style={{ color: "var(--accent-primary)", lineHeight: "2" }}
                  >
                    |Φ⁺⟩ = CNOT · (H ⊗ I) · |00⟩
                  </div>
                  <div
                  ...
                  >
                    Read right to left: first apply H⊗I (H on q₁, Identity on
                    q₂), then apply CNOT.
                  </div>
                </div>
              ...
              <>
                ...
                >
                  ...
                  */}
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        fontWeight: "bold",
                        color: "#b28215",
                        background: "rgba(178,130,21,0.08)",
                        justifySelf: "center",
                      }}
                    >
                      M
                  ...
                  >
                    q₁ on top (CNOT target ⊕) · q₀ at bottom (H gate + CNOT
                    control ●)
                  </div>
                </div>
                  ...
                  */}
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns:
                        "80px 14px 44px 14px 44px 14px 44px 14px 44px 14px 44px",
                      minWidth: "480px",
                      alignItems: "center",
                    }}
                  >
                  ...
                  >
                    Dashed lines = classical bits sent from Alice. X applied if
                    m_A=1. Z applied if m_Q=1.
                  </div>
                </div>
                ...
                >
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns:
                        "60px 80px 60px 60px 80px 60px 60px 60px",
